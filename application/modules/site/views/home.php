                                            ...
                                            <div class="figure-block">
                                                <figure class="item-thumb">
                                                    ...
                                                    <a href="#" class="hover-effect">
                                                        <img src="http://lorempixel.com/355/240/?v=<?php echo rand(1,999999999); ?>" alt="thumb">
                                                    </a>
                                                    <ul class="actions">
                                                        <li class="share-btn">
                                        ...
                                        <div class="property-item item-grid">
                                            <div class="figure-block">
                                                <figure class="item-thumb">
                                                    ...
                                                    <a href="#" class="hover-effect">
                                                        <img src="http://lorempixel.com/355/240/?v=<?php echo md5(time() . rand(1,999999999)); ?>" alt="thumb">
                                                    </a>
                                                    <ul class="actions">
                                                        <li class="share-btn">
                                                            <div class="share_tooltip fade">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="agents-block">
                            ...
                            <div class="web-logo text-center">
                                <img src="<?php echo base_url('assets/site/images/houzez-logo-grey.png'); ?>" alt="logo">
                            </div>
