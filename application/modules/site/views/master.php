...
<head>
    ...
    <link rel="apple-touch-icon" sizes="144x144" href="/assets/site/images/favicons/apple-touch-icon.png">
    ...
    <link rel="mask-icon" href="/assets/site/images/favicons/safari-pinned-tab.svg">
    <meta name="theme-color" content="#ffffff">

    <link href="/assets/site/css/main.css" rel="stylesheet" type="text/css" />
...
<header id="header-section" class="header-section-4 header-main nav-left hidden-sm hidden-xs" data-sticky="1">
    <div class="container">
        <div class="header-left">
            <div class="logo">
                <a href="index.html">
                    <img src="/assets/site/images/houzez-logo-color.png" alt="logo">
                </a>
            </div>
...
<div class="header-mobile visible-sm visible-xs">
    <div class="container">
        ...
        <div class="header-logo">
            <a href="index.html"><img src="/assets/site/images/logo-houzez-white.png" alt="logo"></a>
        </div>
...
<!--end header section header v1-->
    ...
    <script type="text/javascript" src="/assets/site/js/jquery.matchHeight-min.js"></script>
    <script type="text/javascript" src="/assets/site/js/bootstrap-select.js"></script>
    <script type="text/javascript" src="/assets/site/js/jquery-ui.js"></script>
    <script type="text/javascript" src="/assets/site/js/isotope.pkgd.min.js"></script>
    <script type="text/javascript" src="/assets/site/js/jquery.nicescroll.js"></script>
    <script type="text/javascript" src="/assets/site/js/jquery.parallax-1.1.3.js"></script>
