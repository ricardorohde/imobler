...
"São Paulo"=> json_encode(array('tipo'=>'bairro','id'=>34)),
...
foreach ($items as $key=>$value) {
	if (strpos(strtolower($key), $q) !== false) {
		$categorias = array('Cidades', 'Bairros');
		array_push($result, array("id"=>$value, "label"=>$key, "value" => strip_tags($key), "category" => $categorias[rand(0,1)]));
	}
	if (count($result) > 11)
		break;
}
...
if ($this->input->get('callback')) {
	...
	// the callback name.
	$output = htmlspecialchars($this->input->get('callback')) . "($output);";
}
