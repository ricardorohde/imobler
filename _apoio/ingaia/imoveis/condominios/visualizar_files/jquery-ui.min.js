...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
	    closeText: 'Concluido', // Display text for close link
	    ...
	    monthNames: ['Janeiro', 'Fevereiro', 'Marco', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro'], // Names of months for drop-down and formatting
	...
	this._defaults = { // Global defaults for all the date picker instances
	    ...
	    showMonthAfterYear: false, // True if the year select precedes month, false for month then year
	    yearRange: '-70:+10', // Range of years to display in drop-down,
